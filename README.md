...
キー割り当て書き換えツール[Remap](https://remap-keys.app)がQMKファームウェアのバージョン 0.22.2以降に対応したことに伴い、新しくビルドしたSandyのファームウェアを公開しました。  
参考：[Remap supports QMK Firmware 0.22.2 or higher](https://remap-keys.app/docs/support-qmk-022)
