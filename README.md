...
先に挙げた課題の解決案は、以下のようになります。

1. 平面上のスイッチ配置、縦と横の2方向の最適化  
  →3Dキーキャップを使用し、高さ方向の最適化を加える  
  →5行から4行に減らすなど、キー数を減らしてレイアウトの自由度を上げる
...
3Dキーキャップは対応するキーボードが限られてしまうことや、デザインや色のバリエーションが少なくキーの刻印がないなどの理由で、〓ボツ
〓バリエーション豊富な、普通に市販されているキーキャップセットを使いたい
