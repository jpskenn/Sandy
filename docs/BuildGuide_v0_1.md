...
| スペーサー 丸型または六角 両メネジ, M2 3mm | 8 | |
| 六角ナット（2種）, M2 | 22 | |
| ワッシャー, M2用 φ2.3 t=0.4 | 11 | |
...
| 六角ナット（2種）, M2 | 2 | プラ板取り付け用|
| ワッシャー, M2用 φ2.3 t=0.4 | 2 | プラ板取り付け用 |
| ネジ, M2 7mm | 2 | プラ板取り付け用 |
...
1. （該当者のみ）LEDディフューザーのタブを切り取る。
    ...
    *かつ*
    *`左Ctrl`、または`右Enter`に1.5uのキーを取り付ける場合。*  

    LEDディフューザーのタブを、手でパキッと折ったりニッパーで切り取ります。  
    切り取った部分にやすりをかけたりして、滑らかにします。
...
1. （オプション）インジケータLEDを取り付ける
    ...
    うら側のLeft LEDsとRight LEDsを、取り付けたLEDに合わせてONまたはOFFへジャンパします。
...
1. （オプション）プラ板をLEDディフューザーとして取り付ける
    プラ板を良い感じに切り取ってディフューザーとして使用することもできます。
...
1. ケーブルを基板間の隙間へ逃しつつ、基板Topを基板Midへ乗せる。
