...
1. 基板Midへ、ダイオードを取り付ける  
うら側

1. 基板Midへ、コネクタを取り付ける  
うら側

1. （オプション）基板Midへ、5方向スイッチを取り付ける  
...
1. 基板Baseへ、コネクタを取り付ける  
おもて側

1. （オプション）基板Baseへ、ロータリーエンコーダを取り付ける  
...
基板Baseに3mmのスペーサーをいくつか（左右と中央で4個くらい）配置します。  
...
1. 基板Midへコネクタ付きコード（3本）を取り付ける。

1. 基板Baseと基板Midをスペーサー（11本）で固定する。  
コネクタ付きコードを挟まないように気を付ける。

1. 基板Midのコネクタ付きコードを、基板Baseの横向きに向かい合っているコネクタへ差し込む。  

1. コードを基板間の隙間へ逃す。

1. 基板Topへコネクタ付きコード（3本）を取り付ける。

1. 基板Topのコネクタ付きコードを、基板Baseの縦向きに並んだコネクタへ差し込む。  
